...
```
curl -L -o dog https://github.com/trystanscottlambert/dog/releases/download/v0.5.1/dog-aarch64-apple-darwin
chmod +x dog
...
```
curl -L -o dog https://github.com/trystanscottlambert/dog/releases/download/v0.5.1/dog-x86_64-apple-darwin
chmod +x dog
sudo mv dog /usr/local/bin/
```
...
```
curl -L -o dog https://github.com/trystanscottlambert/dog/releases/download/v0.5.1/dog-x86_64-unknown-linux-gnu
chmod +x dog
sudo mv dog /usr/local/bin/
```
