...
```
curl -L -o dog https://github.com/trystanscottlambert/dog/releases/download/v0.3.5/dog-aarch64-apple-darwin
...
```
curl -L -o dog https://github.com/trystanscottlambert/dog/releases/download/v0.3.5/dog-x86_64-apple-darwin
...
```
curl -L -o dog https://github.com/trystanscottlambert/dog/releases/download/v0.3.5/dog-x86_64-unknown-linux-gnu
